...
<div class="container-fluid">
    ...
    <div class="col-lg-12">
        <div class="card">
            <form method="post" action="{{ url('/oncall/masuk') }}" class="p-4">
                @csrf
                <div class="form-row">
                    <div class="col"></div>
                    <div class="col">
    ...
    @elseif($cek_oncall > 0 && $jam_masuk == true && $jam_keluar == null)
    <div class="col-lg-12">
        <div class="card">
            <form method="post" action="{{ url('/oncall/pulang/'.$id) }}" class="p-4">
                @method('put')
                @csrf
                <div class="form-row">
                    <div class="col"></div>
                    ...
                    <div class="col">
                        ...
                        <input type="hidden" name="total_oncall">
                    </div>
                </div>
                <center>
                    <button type="submit" class="btn btn-primary" value="Ambil Foto"
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="p-4">
                <center>
                    <h2>Anda Sudah Selesai Oncall Hari Ini</h2>
                </center>
            </div>
        </div>
    </div>
