        ...
        <div class="card">
            <div class="row">
                ...
                <div class="col-md-6 p-0">
                    ...
                    <a href="{{ url('/lokasi-kantor/pending-location') }}" class="btn btn-warning float-right btn-sm"><i
                            class="fa fa-hourglass-start me-2"></i> Pending Location</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="action">
                                        <li>
                                            <a href="{{ url('/lokasi-kantor/edit/'.$dl->id) }}"><i style="color:blue"
                                                    class="fa fa-solid fa-edit"></i></a>
                                        </li>
                                        <li class="delete">
                                            <form action="{{ url('/lokasi-kantor/delete/'.$dl->id) }}" method="post"
                                                class="d-inline">
                                                @method('delete')
                                                @csrf
                                                ...
                                                <button class="border-0 delete-btn" data-item-name="data lokasi"
