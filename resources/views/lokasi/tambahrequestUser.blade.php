            ...
            <div class="tf-balance-box">
                ...
                <form method="post" class="tf-form" action="{{ url('/request-location/tambah-proses') }}">
                    @csrf
                        ...
                        <div class="group-input">
                            <label for="nama_lokasi">Nama Lokasi</label>
                            <input type="text" class="@error('nama_lokasi') is-invalid @enderror" id="nama_lokasi" name="nama_lokasi" autofocus value="{{ old('nama_lokasi') }}" required>
                        </div>
                        <div class="group-input">
                            <label for="radius">Radius (Meter)</label>
                            <input type="text" class="@error('radius') is-invalid @enderror" id="radius" name="radius" autofocus value="{{ old('radius') }}" required>
                        </div>
                        <input type="hidden" name="status" value="pending">
                        <input type="hidden" name="created_by" value="{{ auth()->user()->id }}">
