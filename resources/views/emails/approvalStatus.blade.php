...
<head>
    ...
    <title>{{ $feature }} Approval Notification</title>
    <style>
        body {
...
<div class="email-container">
    ...
    <p>{{ $notif }}</p>
    <p>Untuk mengecek status {{ $feature }}, klik tombol di bawah ini:</p>
    <div style="text-align: center;">
        <a href="{{ $url }}" class="button-link" target="_blank">Halaman {{ $feature }}</a>
    </div>
    <p>Thank you!</p>
