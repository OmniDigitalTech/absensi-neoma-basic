...
<div class="card-secton transfer-section">
    <div class="tf-container">
        <div class="tf-balance-box">
            <form method="post" class="tf-form" action="{{ url('/cuti/proses-edit/'.$data_cuti_user->id) }}"
                ...
                <div class="group-input">
                    ...
                    <input type="datetime" class="@error('tanggal_mulai') is-invalid @enderror" name="tanggal_mulai"
                        id="tanggal_tanggal" value="{{ old('tanggal_mulai', $data_cuti_user->tanggal_mulai) }}">
                    @error('tanggal_mulai')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="group-input">
                    ...
                    <input type="datetime" class="@error('tanggal_akhir') is-invalid @enderror" name="tanggal_akhir"
                        id="tanggal_akhir" value="{{ old('tanggal_akhir', $data_cuti_user->tanggal_akhir) }}">
                    @error('tanggal_akhir')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="group-input">
                    ...
                    <input type="text" class="@error('alasan_cuti') is-invalid @enderror" id="alasan_cuti"
                        name="alasan_cuti" value="{{ old('alasan_cuti', $data_cuti_user->alasan_cuti) }}">
                    @error('alasan_cuti')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
