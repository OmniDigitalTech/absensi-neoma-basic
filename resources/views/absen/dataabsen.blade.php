                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('/maps/'.$da->lat_absen.'/'.$da->long_absen.'/'.$da->User->id) }}"
                                        ...
                                        target="_blank"><i class="fa fa-eye me-2"></i> Lihat</a>
                                ...
                                <td>
                                    ...
                                    <span class="badge badge-danger">Belum Absen</span>
                                    @else
                                    <img src="{{ url('storage/' . $da->foto_jam_absen) }}" style="width: 60px" alt="Foto jam absen"
                                        onclick="showModal(this, '{{ url('storage/'.$da->foto_jam_absen) }}')">
                                    @endif
                                </td>
                                <!-- <td>
                                    @if($da->status_absen == 'Libur')
                                ...
                                <td>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                    @if($jam <= 0 && $menit2 <=0) <span class="badge badge-success">Tidak Pulang
                                        Cepat</span>
                                        @else
                                        <span class="badge badge-danger">{{ $jam." Jam ".$menit2." Menit" }}</span>
                                        @endif
                                ...
                                <td>
                                    ...
                                    <span class="badge badge-warning">Belum Pulang</span>
                                    @else
                                    <img src="{{ url('storage/' . $da->foto_jam_pulang) }}" style="width: 60px" alt="Foto jam pulang"
                                        onclick="showModal(this, '{{ url('storage/'.$da->foto_jam_pulang) }}')">
                                    @endif
                                </td>
                                <!-- <td>
                                    @if($da->status_absen == 'Libur')
                                ...
                                <td>
                                    ...
                                    @elseif($da->status_absen == 'Cuti' || $da->status_absen == 'Izin Telat' ||
                                    ...
                                    <ul class="action">
                                        ...
                                        <li class="delete">
                                            <form action="{{ url('/data-absen/'.$da->id.'/delete') }}" method="post"
                                                ...
                                                <button class="border-0 delete-btn" data-item-name="data absen"
                                                    style="background-color: transparent;"> <i class="fa fa-solid fa-trash"></i>
                                                </button>
                                            </form>
                                        </li>
                                        @endif
