                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php
                                    ...
                                    $detik = $telat % 60;
                                ?>
                        @if($jam <= 0 && $menit2 <=0) Tepat Waktu @else {{ $jam." Jam ".$menit2." Menit" }} @endif
                            @endif </td>
                    <td>
                        @if($da->status_absen == 'Libur')
                        Libur
                    ...
                    <td>
                        ...
                        Belum Absen
                        @else
                        <img cursor:pointer; src="{{ url('storage/'.$da->foto_jam_absen) }}" style="width:60px"
                            alt="Image" onclick="showModal(this, '{{ url('storage/'.$da->foto_jam_absen) }}')">
                    ...
                    <td>
                        ...
                        <?php
                                    ...
                                    ?>
                        @if($jam <= 0 && $menit2 <=0) Tidak Pulang Cepat @else {{ $jam." Jam ".$menit2." Menit" }}
                            @endif @endif </td>
                    <td>
                        @if($da->status_absen == 'Libur')
                        Libur
                    ...
                    <td>
                        ...
                        Belum Pulang
                        @else
                        <img cursor:pointer; src="{{ url('storage/'.$da->foto_jam_pulang) }}" style="width:60px"
                            alt="Image" onclick="showModal(this, '{{ url('storage/'.$da->foto_jam_pulang) }}')">
                    ...
                    <td>
                        @if($da->status_absen == 'Libur')
                        Libur
                        @elseif($da->status_absen == 'Cuti' || $da->status_absen == 'Izin Telat' || $da->status_absen ==
                        'Izin Pulang Cepat')
                        {{ $da->status_absen }}
                    ...
                    <!-- <td>
                        @if ($da->tanggal < date('Y-m-d')) @if ($da->jam_masuk_pengajuan == null)
