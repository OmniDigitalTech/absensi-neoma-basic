        ...
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                <div class="text-center">
                    ...
                    <img class="profile-user-img img-fluid img-circle" src="{{ url('assets/img/foto_default.jpg') }}"
                        class="img-circle elevation-2" alt=" User profile picture">
                    @else
                    <img class="profile-user-img img-fluid img-circle"
                        src="{{ url('storage/'.auth()->user()->foto_karyawan) }}" class="img-circle elevation-2" alt="
                        ...
                        <form method="post" action="{{ url('/my-profile/update/'.auth()->user()->id) }}"
                            ...
                            <div class="form-row">
                                <div class="col mb-4">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" autofocus value="{{ old('name', auth()->user()->name) }}">
                                    @error('name')
                                ...
                                <input type="hidden" name="foto_karyawan_lama"
                                    value="{{ auth()->user()->foto_karyawan }}">
                            </div>
                            <div class="form-row">
                                <div class="col mb-4">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col mb-4">
                                    ...
                                    <input type="text" id="is_admin" value="{{ auth()->user()->is_admin }}"
                            ...
                            <div class="form-row">
                                <div class="col mb-4">
                                    ...
                                    <input type="datetime" class="form-control @error('tgl_join') is-invalid @enderror"
                                        ...
                                        value="{{ old('tgl_join', auth()->user()->tgl_join) }}">
                                    @error('tgl_join')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col mb-4">
                                    ...
                                    <input type="number"
                                        class="form-control @error('izin_lainnya') is-invalid @enderror"
                                        id="izin_lainnya" name="izin_lainnya"
                            ...
                            <div class="form-row">
                                <div class="col mb-4">
                                    ...
                                    <input type="number" class="form-control @error('izin_telat') is-invalid @enderror"
                                        id="izin_telat" name="izin_telat"
                                ...
                                <div class="col mb-4">
                                    ...
                                    <input type="number"
                                        class="form-control @error('izin_pulang_cepat') is-invalid @enderror"
                                        id="izin_pulang_cepat" name="izin_pulang_cepat"
                                        value="{{ old('izin_pulang_cepat', auth()->user()->izin_pulang_cepat) }}"
                                        readonly>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col mb-4">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text"
                                            class="form-control money @error('makan_transport') is-invalid @enderror"
                                            name="makan_transport"
                                            value="{{ old('makan_transport', auth()->user()->makan_transport) }}"
                                            readonly>
                                        <div class="input-group-text">
                                            <span>/ Bulan</span>
                                        </div>
                                ...
                                <div class="col mb-4">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text"
                                            ...
                                            name="lembur" value="{{ old('lembur', auth()->user()->lembur) }}" readonly>
                                        <div class="input-group-text">
                                            <span>/ Jam</span>
                                        </div>
                                        @error('lembur')
                                ...
                                <div class="col mb-4">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text"
                                            ...
                                            name="kehadiran" value="{{ old('kehadiran', auth()->user()->kehadiran) }}"
                                            readonly>
                                        <div class="input-group-text">
                                            <span>/ Bulan</span>
                                        </div>
                            ...
                            <div class="form-row">
                                <div class="col mb-4">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control money @error('thr') is-invalid @enderror"
                                            name="thr" value="{{ old('thr', auth()->user()->thr) }}" readonly>
                                        <div class="input-group-text">
                                            <span>/ Bulan</span>
                                        </div>
                                        @error('thr')
                                ...
                                <div class="col mb-4">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text"
                                            class="form-control money @error('bonus') is-invalid @enderror" name="bonus"
                            ...
                            <div class="form-row">
                                <div class="col mb-4">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text"
                                            class="form-control money @error('izin') is-invalid @enderror" name="izin"
                                ...
                                <div class="col mb-4">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text"
                                            ...
                                            name="terlambat" value="{{ old('terlambat', auth()->user()->terlambat) }}"
                                            readonly>
                                        <div class="input-group-text">
                                            <span>/ hari</span>
                                        </div>
                                ...
                                <div class="col mb-4">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text"
                                            ...
                                            name="mangkir" value="{{ old('mangkir', auth()->user()->mangkir) }}"
                                            readonly>
                                        <div class="input-group-text">
                                            <span>/ hari</span>
                                        </div>
