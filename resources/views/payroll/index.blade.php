...
{{--                                <td>Rp {{ number_format($d->bayar_kasbon) }}</td>--}}
                                ...
                                <td>
                                    <ul class="action">
                                        <li class="me-2">
                                            <a href="{{ url('/payroll/'.$d->id.'/download') }}" target="_blank"><i
                                                    style="color:blue" class="fa fa-solid fa-print"></i></a>
                                        </li>

                                        @can('admin')
                                        <li>
                                            <a href="{{ url('/payroll/'.$d->id.'/edit') }}"><i style="color: brown"
                                                    class="fa fa-solid fa-edit"></i></a>
                                        </li>
                                        <li class="delete">
                                            <form action="{{ url('/payroll/'.$d->id.'/delete') }}" method="post"
                                                class="d-inline">
                                                @method('delete')
                                                @csrf
