  ...
  $(function () {
    ...
    var calendar = new Calendar(calendarEl, {
      ...
      events: [
        ...
        @endforeach
        @php
          $data_cuti = App\Models\Cuti::select('user_id', 'tanggal_mulai')->where('status_cuti', 'Diterima')->whereBetween('tanggal_mulai', [$tgl_mulai, $tgl_akhir])->get();
        @endphp
        @foreach($data_cuti as $dc)
          @php
            $pecah2 = explode("-", $dc->tanggal);
            \Illuminate\Support\Facades\Log::info($pecah2);
          @endphp
          {
