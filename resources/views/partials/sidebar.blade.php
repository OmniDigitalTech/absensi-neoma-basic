<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/dashboard') }}" class="brand-link">
        ...
        <a href="{{ url('/absen') }}" class="brand-link">
            @endif
            <img src="{{ url('assets/img/absensi.png') }}" alt="AdminLTE Logo"
                class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">E-Prensesi</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex {{ Request::is('my-profile*') ? 'btn btn-primary' : '' }}">
                <div class="image">
                    ...
                    @else
                    <img src="{{ url('storage/'.auth()->user()->foto_karyawan) }}" class="img-circle elevation-2"
                        alt="User Image">
                    @endif
                </div>
                <div class="info">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/lokasi-kantor') }}"
                            class="nav-link {{ Request::is('lokasi-kantor*') ? 'active' : '' }}">
                    ...
                    <!-- {{-- <li class="nav-item">
                            <a href="{{ url('/reset-cuti') }}" class="nav-link
                    {{ Request::is('reset-cuti*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/auto-shift') }}"
                            class="nav-link {{ Request::is('auto-shift*') ? 'active' : '' }}">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            @can('admin')
            <li class="nav-item">
                <a href="{{ url('/data-dinas-luar') }}"
                    class="nav-link {{ Request::is('data-dinas-luar*') ? 'active' : '' }}">
                    <i class="nav-icon fa fa-solid fa-table"></i>
                    <p>
                        Data Dinas Luar
                    </p>
            ...
            <li class="nav-item">
                <a href="{{ url('/my-dinas-luar') }}"
                    class="nav-link {{ Request::is('my-dinas-luar*') ? 'active' : '' }}">
                    <i class="nav-icon fa fa-user-secret"></i>
                    <p>
                        My Dinas Luar
                    </p>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="{{ url('/request-location') }}"
                    class="nav-link {{ Request::is('request-location*') ? 'active' : '' }}">
