...
<head>
    <title>Neoma | Employee Self Service</title>
    <meta charset="utf-8" />
    ...
    <link rel="shortcut icon" href="@if (is_file(url('storage/'.$settings->logo))) {{ url('storage/'.$settings->logo) }}
                ...
                <div class="col-xxl-4 col-lg-5">
                    <div class="card">
                        ...
                        <div class="card-header py-4 text-center bg-primary">
                            <a href="{{ url('/login') }}">
                                <span><img src="@if (is_file(url('storage/'.$settings->logo))) {{ url('storage/'.$settings->logo) }}
                                                @else {{ url('/assets/img/neoma_logo.jpg') }}
                                                @endif" alt="Logo Perusahaan" height="70"></span>
                            </a>
                        </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <p class="mb-9 fw-3 text-center ">Belum punya akun? <a href="{{ url('/register') }}"
                                    class="auth-link-rg">Daftar Sekarang</a></p>
                        </div> <!-- end card-body -->
                    </div>
                    <!-- end card -->
                    <!-- end row -->
