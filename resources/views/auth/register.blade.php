...
<form class="tf-form" action="{{ url('/register-proses') }}" method="POST">
    ...
    <div class="group-input">
        ...
        <input type="text" placeholder="Full Name" class="@error('name') is-invalid @enderror" value="{{ old('name') }}"
            name="name">
        @error('name')
    ...
    <div class="group-input">
        ...
        <input type="text" placeholder="NIK" class="@error('nik') is-invalid @enderror" value="{{ old('nik') }}" name="nik">
        @error('nik')
        <div>
            {{$message}}
        </div>
    ...
    <div class="group-input mt-4">
        <label>Email</label>
        <input type="email" placeholder="Example@mail.com" class="@error('email') is-invalid @enderror"
    ...
    <div class="group-input auth-pass-input last mt-4">
        ...
        <input type="password" class="password-input @error('password_confirmation') is-invalid @enderror"
