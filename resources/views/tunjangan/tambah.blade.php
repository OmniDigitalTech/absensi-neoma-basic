                    ...
                    <form method="post" action="{{ url('/tunjangan/tambah-proses') }}">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control money @error('thr') is-invalid @enderror" id="thr" name="thr" autofocus value="{{ old('thr') }}">
                                @error('thr')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control money @error('bonus') is-invalid @enderror" id="bonus" name="bonus" autofocus value="{{ old('bonus') }}">
                                @error('bonus')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
